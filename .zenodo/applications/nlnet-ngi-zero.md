...
**The work.** A machine-checked deposit: 525 theorems accepted by the Lean 4 kernel, each closing by exhaustion over a finite domain, sorry-free and axiom-free with no Mathlib dependency. Concept DOI [10.5281/zenodo.21819217](https://doi.org/10.5281/zenodo.21819217). Source: https://github.com/ceccec/millennium-solutions. Pages: https://ceccec.psg.bg/millennium-solutions.
...
- a concrete technical deliverable, not a research promise — 525 kernel-accepted theorems closing by exhaustion, plus a working verifier, an MCP server and a published package — all recomputable from source
