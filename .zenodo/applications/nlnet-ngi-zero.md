...
- a concrete technical deliverable, not a research promise — 521 kernel-accepted theorems closing by exhaustion, plus a working verifier, an MCP server and a published package — all recomputable from source
