...
| Released versions (git tags) | **814** |
| Tracked, content-addressed files | **456** |

Latest release: **v8.6.6**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `1e39987e-1c93-885e-b684-29cc78ba12b0`. Integrity, not truth. `entails → 0/7`.
