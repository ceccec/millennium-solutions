...
| Released versions (git tags) | **777** |
| Tracked, content-addressed files | **770** |

Latest release: **v8.2.9**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `a328e1ea-8ee7-8e36-a3e1-d24a9fd3b363`. Integrity, not truth. `entails → 0/7`.
