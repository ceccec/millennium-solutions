...
| Released versions (git tags) | **593** |
| Tracked, content-addressed files | **289** |

Latest release: **v6.4.5**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `29aeeef8-964f-8735-b028-6cdeb782e93d`. Integrity, not truth. `entails → 0/7`.
