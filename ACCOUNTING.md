...
| Released versions (git tags) | **765** |
| Tracked, content-addressed files | **766** |

Latest release: **v8.1.7**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `1591f9c6-697f-88e3-8c70-f0dac7f83d8d`. Integrity, not truth. `entails → 0/7`.
