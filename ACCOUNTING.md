...
| Quantity | Value |
|---|---|
| Decidable theorems (chained receipts) | **3,128** |
| Signed statement receipts | **32** |
| Coins per receipt | **2** |
| Coins on the ledger (theorems × 2) | **6,256** |
| Coins on signed receipts (× 2) | **64** |
| Released versions (git tags) | **922** |
| Tracked, content-addressed files | **550** |
...
The bounty for each accepted contribution is **2 bits (2 coins)** — the same fair-exchange unit, earned by the deed (a gate-passing, receipted contribution) and owed by commercial use. Total bounty accounted on the ledger so far: **6,256 bits**. This is an accounting bounty in bits/coins — **integrity, not a cash prize**. Heroes and traitors by deeds, not claims.
...
Page content-address: `c38901f7-758d-81f2-83c1-251e67168b7b`. Integrity, not truth.
