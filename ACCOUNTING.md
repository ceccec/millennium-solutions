...
| Released versions (git tags) | **796** |
| Tracked, content-addressed files | **528** |

Latest release: **v8.4.8**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `d8964e07-6b1d-8fff-987c-85c811c33db4`. Integrity, not truth. `entails → 0/7`.
