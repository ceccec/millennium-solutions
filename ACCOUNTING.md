...
| Released versions (git tags) | **770** |
| Tracked, content-addressed files | **767** |

Latest release: **v8.2.2**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `3d5370a2-16a3-8aa7-951d-0e8ba0c54398`. Integrity, not truth. `entails → 0/7`.
