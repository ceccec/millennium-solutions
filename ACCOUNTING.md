...
| Released versions (git tags) | **613** |
| Tracked, content-addressed files | **295** |

Latest release: **v6.6.5**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `3027a067-2445-87bf-9d63-dd685b1145ea`. Integrity, not truth. `entails → 0/7`.
