...
| Released versions (git tags) | **899** |
| Tracked, content-addressed files | **523** |

Latest release: **v9.5.1**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `b094ec16-944f-8eaa-8b54-22402b4048a3`. Integrity, not truth.
