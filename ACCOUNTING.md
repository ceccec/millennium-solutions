...
| Released versions (git tags) | **750** |
| Tracked, content-addressed files | **386** |

Latest release: **v8.0.2**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `711491ba-82f2-8d50-963c-58ee952d5e79`. Integrity, not truth. `entails → 0/7`.
