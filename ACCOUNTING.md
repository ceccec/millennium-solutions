...
| Released versions (git tags) | **630** |
| Tracked, content-addressed files | **299** |

Latest release: **v6.8.2**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `8c85b1ff-7f1b-8c3c-95e0-cbf4bc56ede0`. Integrity, not truth. `entails → 0/7`.
