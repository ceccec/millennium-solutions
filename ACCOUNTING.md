...
| Released versions (git tags) | **830** |
| Tracked, content-addressed files | **457** |

Latest release: **v8.8.2**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `adefeb77-ac82-8390-ac69-ecfbc839a1a5`. Integrity, not truth. `entails → 0/7`.
