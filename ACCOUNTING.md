...
| Released versions (git tags) | **747** |
| Tracked, content-addressed files | **382** |

Latest release: **v7.9.9**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `a7d92dda-df6f-8343-8067-ca356bb565ac`. Integrity, not truth. `entails → 0/7`.
