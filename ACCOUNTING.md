...
| Released versions (git tags) | **729** |
| Tracked, content-addressed files | **374** |

Latest release: **v7.8.1**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `5bbaf414-cb5e-8191-989d-16582fad51d8`. Integrity, not truth. `entails → 0/7`.
