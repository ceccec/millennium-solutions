...
| Quantity | Value |
|---|---|
| Decidable theorems (chained receipts) | **2,904** |
| Signed statement receipts | **32** |
| Coins per receipt | **2** |
| Coins on the ledger (theorems × 2) | **5,808** |
| Coins on signed receipts (× 2) | **64** |
| Released versions (git tags) | **919** |
| Tracked, content-addressed files | **537** |
...
The bounty for each accepted contribution is **2 bits (2 coins)** — the same fair-exchange unit, earned by the deed (a gate-passing, receipted contribution) and owed by commercial use. Total bounty accounted on the ledger so far: **5,808 bits**. This is an accounting bounty in bits/coins — **integrity, not a cash prize**. Heroes and traitors by deeds, not claims.
...
Page content-address: `547617c2-2687-8c9c-b4bf-105ed4fa3c3a`. Integrity, not truth.
