...
| Released versions (git tags) | **884** |
| Tracked, content-addressed files | **517** |

Latest release: **v9.3.6**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `277b54be-c1cb-8878-a4da-065506af25e9`. Integrity, not truth.
