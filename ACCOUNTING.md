...
| Released versions (git tags) | **730** |
| Tracked, content-addressed files | **374** |

Latest release: **v7.8.2**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `48091dc0-57f7-89ca-a3b4-3f9b619c437d`. Integrity, not truth. `entails → 0/7`.
