...
| Released versions (git tags) | **780** |
| Tracked, content-addressed files | **772** |

Latest release: **v8.3.2**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `b4e5a0f2-d2b3-8549-a9b4-727858a3f60c`. Integrity, not truth. `entails → 0/7`.
