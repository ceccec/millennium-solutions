...
| Released versions (git tags) | **779** |
| Tracked, content-addressed files | **771** |

Latest release: **v8.3.1**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `46049cd8-ff5b-84bc-90a9-16251a9d21ea`. Integrity, not truth. `entails → 0/7`.
