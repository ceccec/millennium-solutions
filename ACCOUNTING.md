...
| Released versions (git tags) | **782** |
| Tracked, content-addressed files | **773** |

Latest release: **v8.3.4**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `c8353a75-921c-89f1-8cc8-d817b0012489`. Integrity, not truth. `entails → 0/7`.
