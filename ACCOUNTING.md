...
| Released versions (git tags) | **804** |
| Tracked, content-addressed files | **531** |

Latest release: **v8.5.6**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `12b1808d-3bae-876a-8ec8-df4ce024612d`. Integrity, not truth. `entails → 0/7`.
