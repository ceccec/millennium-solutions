...
| Released versions (git tags) | **878** |
| Tracked, content-addressed files | **513** |

Latest release: **v9.3.0**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `17f0aaa1-53f4-8398-8a33-175bba0cd1a2`. Integrity, not truth.
