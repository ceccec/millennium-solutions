...
| Released versions (git tags) | **702** |
| Tracked, content-addressed files | **308** |

Latest release: **v7.5.4**. The fair-exchange unit is **2 coins = 2 bits** (110 − 108 = 2 = −χ genus-2) per receipt. One 64-bit harmony coin is minted per fused `src` `report()` module — see the [state dashboard](/dashboard) for the harmonic root.
...
Page content-address: `4f88c663-3ec6-80a5-8f86-0ba031892fbc`. Integrity, not truth. `entails → 0/7`.
