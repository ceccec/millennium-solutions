...
Derived on every run from 287 sources: **140 corrections** the deposit recorded about itself,
...
| 27 | the instrument was wrong, not the code | a finding is evidence about the finder until the finder has been run against a known case |
...
| 9 | a flattering number survived | a result that clears you is checked less than one that accuses you |
