...
Of 534 machine-checked declarations, **196** restate work that already has an author and
**338** are about this deposit's own construction. Each source file declares which it is, in its own
...
| | theorems |
|---|---|
| attributed to named earlier work | **196** |
| unclassified — no search performed, status unknown | **338** |
| claimed as novel | **0** |

**Zero claims is not full attribution.** Stated alone, "this deposit claims no novelty" reads as a concession
that everything here already has an author. It is not that. **338** theorems have had no prior-art
...
searched, where, and when. An earlier version of this page claimed novelty for 13 sources and
338 theorems on the strength of their own self-description, with nobody having looked. Asserting
that nothing earlier exists because no one went to check is the same defect as asserting a proof because no
one went to read it.

## Restated from named earlier work — 17 sources, 196 theorems
...
## This deposit's own construction — 13 sources, 338 theorems, none claimed
...
<tr><td><code>coin.lean</code></td><td>12</td><td>—</td></tr>
<tr><td><code>generated.lean</code></td><td>14</td><td>—</td></tr>
<tr><td><code>imagined.lean</code></td><td>118</td><td>—</td></tr>
<tr><td><code>index.lean</code></td><td>11</td><td>—</td></tr>
<tr><td><code>ledgerclaims.lean</code></td><td>8</td><td>—</td></tr>
<tr><td><code>mechanical.lean</code></td><td>105</td><td>—</td></tr>
<tr><td><code>merkaba.lean</code></td><td>8</td><td>—</td></tr>
...
Partition seal `54df56c2-3982-844c-b8bf-2f0c0554104a` · recompute with `node scripts/priorart.ts` · the kernel re-decides
