...
Of 586 machine-checked declarations, **577** restate work that already has an author and
...
| | theorems |
|---|---|
| attributed to named earlier work | **577** |
...
## Restated from named earlier work — 30 sources, 577 theorems
...
<tr><td><code>families.lean</code></td><td>34</td><td>modular arithmetic, quantified</td><td>quantifies the ℤ/9 arithmetic above; the underlying results are Fermat’s, Euler’s and Gauss’s</td></tr>
...
- **modular arithmetic, quantified** — 34 theorems, in `families.lean`
