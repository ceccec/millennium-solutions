...
Of 622 machine-checked declarations, **613** restate work that already has an author and
...
| | theorems |
|---|---|
| attributed to named earlier work | **613** |
...
## Restated from named earlier work — 31 sources, 613 theorems
...
<tr><td><code>elementary.lean</code></td><td>27</td><td>elementary number theory and combinatorial game theory</td><td>Euclid (Elements IX.36) and Euler for the even perfect numbers; the amicable pair</td></tr>
...
- **elementary number theory and combinatorial game theory** — 27 theorems, in `elementary.lean`
