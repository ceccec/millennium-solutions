...
Of 575 machine-checked declarations, **566** restate work that already has an author and
...
| | theorems |
|---|---|
| attributed to named earlier work | **566** |
...
## Restated from named earlier work — 30 sources, 566 theorems
...
<tr><td><code>families.lean</code></td><td>23</td><td>modular arithmetic, quantified</td><td>quantifies the ℤ/9 arithmetic above; the underlying results are Fermat’s, Euler’s and Gauss’s</td></tr>
...
- **hash trees and membership proofs** — 29 theorems, in `ledgerclaims.lean`, `merkle.lean`, `speed.lean`
...
- **modular arithmetic, quantified** — 23 theorems, in `families.lean`
