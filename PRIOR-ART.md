...
Of 815 machine-checked declarations, **806** restate work that already has an author and
...
| | theorems |
|---|---|
| attributed to named earlier work | **806** |
...
## Restated from named earlier work — 32 sources, 806 theorems
