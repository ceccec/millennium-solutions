...
Of 499 machine-checked declarations, **167** restate work that already has an author and
**332** are about this deposit's own construction. Each source file declares which it is, in its own
...
| unclassified — no search performed, status unknown | **332** |
| claimed as novel | **0** |

**Zero claims is not full attribution.** Stated alone, "this deposit claims no novelty" reads as a concession
that everything here already has an author. It is not that. **332** theorems have had no prior-art
...
332 theorems on the strength of their own self-description, with nobody having looked. Asserting
...
## This deposit's own construction — 13 sources, 332 theorems, none claimed
...
<tr><td><code>coin.lean</code></td><td>8</td><td>—</td></tr>
...
<tr><td><code>mechanical.lean</code></td><td>103</td><td>—</td></tr>
