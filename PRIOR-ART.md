...
| unclassified — no search performed, status unknown | **324** |
| claimed as novel | **0** |

**Zero claims is not full attribution.** Stated alone, "this deposit claims no novelty" reads as a concession
that everything here already has an author. It is not that. **324** theorems have had no prior-art
...
324 theorems on the strength of their own self-description, with nobody having looked. Asserting
...
## This deposit's own construction — 12 sources, 324 theorems, none claimed
