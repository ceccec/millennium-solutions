...
Of 470 machine-checked theorems, **167** restate work that already has an author and
**303** are about this deposit's own construction. Each source file declares which it is, in its own
...
| unclassified — no search performed, status unknown | **303** |
| claimed as novel | **0** |

**Zero claims is not full attribution.** Stated alone, "this deposit claims no novelty" reads as a concession
that everything here already has an author. It is not that. **303** theorems have had no prior-art
...
303 theorems on the strength of their own self-description, with nobody having looked. Asserting
...
## This deposit's own construction — 11 sources, 303 theorems, none claimed
...
<tr><td><code>index.lean</code></td><td>9</td><td>—</td></tr>
