...
Of 534 machine-checked declarations, **525** restate work that already has an author and
...
| | theorems |
|---|---|
| attributed to named earlier work | **525** |
...
## Restated from named earlier work — 29 sources, 525 theorems
...
<tr><td><code>speed.lean</code></td><td>8</td><td>hash trees and membership proofs</td><td>the structural claim is Merkle's and is credited here as merkle.lean already credits it:</td></tr>
...
- **hash trees and membership proofs** — 25 theorems, in `ledgerclaims.lean`, `merkle.lean`, `speed.lean`
