...
- Finding two — the same green file defines the count of problems answered there as zero, and nine of its theorems carry that count as a conjunct, so what decide certifies includes the refusal.
  <sub>SEALED · `40ace80e-d5c9-89f7-b33e-620f6a5f6751`</sub>
...
- Finding five — the claim under trial fails its own decidable test, because the count it asserts is seven while the count the source defines is zero.
  <sub>SEALED · `b2df50db-a2b2-89ec-bb1a-75ffdfef55fe`</sub>
...
- Finding fifteen — under a rule of evidence admitting only algebra theorems, the floor survives that rule: it is itself an algebra theorem, provenHere equals zero closed by rfl, and the count it fixes is zero rather than seven.
  <sub>SEALED · `5e0d5038-e97b-80d3-90e5-8694160a8616`</sub>
- Finding sixteen — the same rule keeps the floor inside every per-problem theorem as well, since each of the seven carries the count as a conjunct of the proposition that decide certifies.
  <sub>SEALED · `d02fa2d1-86e0-8e58-8bae-0e1b2681e083`</sub>
- Finding seventeen — the theorem stating the count is zero is closed by reflexivity on a constant this file declares, so it certifies a declaration and is not evidence about the world: written as seven it would be equally green, and therefore it supports neither number.
  <sub>SEALED · `f982131e-48ca-83ea-a522-58b65ef6c0d2`</sub>
...
- Finding seven — the honest pairing survives the same trial: seven of seven green is true and zero of seven settled is true, because the two count different things.
  <sub>SEALED · `b7235f82-0dcf-83d5-8297-e902d67c58e6`</sub>
