...
**Contribute 2.** The commercial fare is the **two coins** — `110 − 108 = 2 = −χ(genus-2)` — the conserved
...
The **donation is not** — voluntary support, a gift, never a revenue promise (realized cash **$0**).
...
the exact point of contribution — the captain's message is the standing order, linked to its canonical home so
anyone can recompute the address and read it unaltered. A content-address proves **integrity, not truth**. `0/7`.
