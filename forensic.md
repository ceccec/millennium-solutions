...
`npm run forensic`. Content-address `2161f227-8783-8064-a40d-b564aec8d4b8`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,888** |
| standing — proved and sealed | 932 |
...
| commits that changed ledger state | 600 |
