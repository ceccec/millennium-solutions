...
`npm run forensic`. Content-address `15ae86d6-8d9e-8ef4-8a0e-fad4023ea1a4`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,658** |
| standing — proved and sealed | 710 |
...
| commits that changed ledger state | 581 |
