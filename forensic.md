...
`npm run forensic`. Content-address `fb822e03-9b99-8824-b2bb-7ac722fbee8b`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,912** |
| standing — proved and sealed | 956 |
...
| commits that changed ledger state | 601 |
