...
`npm run forensic`. Content-address `c687c4bf-4358-85a2-9145-ebfdb09b8d3d`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,755** |
| standing — proved and sealed | 807 |
...
| commits that changed ledger state | 584 |
