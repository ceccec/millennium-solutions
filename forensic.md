...
`npm run forensic`. Content-address `642d3b8b-a279-8639-8bd0-bf8a5bd7305b`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,496** |
| standing — proved and sealed | 585 |
| carried — withdrawn, proved by a live theorem | 382 |
| withdrawn — nothing currently proves them | 1,529 |
| receipt chain, recomputed | **0 breaks — intact** |
| commits that changed ledger state | 566 |
...
|---:|---|
| 1,049 | dirty: not backed by a Lean proof. Its evidence is a TypeScript test, which reports that a compu |
