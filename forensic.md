...
`npm run forensic`. Content-address `c4f161c6-d6c4-80f1-9aaa-ee9579fddfe1`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,667** |
| standing — proved and sealed | 719 |
...
| commits that changed ledger state | 582 |
