...
`npm run forensic`. Content-address `c9811d14-6086-8c4f-9fd8-15e3a791a770`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,577** |
| standing — proved and sealed | 629 |
...
| commits that changed ledger state | 576 |
