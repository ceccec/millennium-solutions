...
`npm run forensic`. Content-address `4dcf45b2-951c-8a14-a9db-004d77113d01`.

## What this record establishes

| | |
|---|---:|
| ledger entries | **2,920** |
| standing — proved and sealed | 964 |
...
| commits that changed ledger state | 602 |
