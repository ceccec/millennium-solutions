...
- The formal layer holds 398 theorems across 21 files, and no file uses sorry or native_decide outside a comment.
  <sub>SEALED · `bd3f6ae3-7f0b-804d-9aa7-ff2dd6c62220`</sub>
- 390 of those 398 theorems close by decide, which is to say the kernel evaluates the proposition over its whole finite domain rather than accepting a declaration; the remaining 8 close by rfl and are declarations.
  <sub>SEALED · `9abb558c-1515-8fd1-9f23-6e49213d414f`</sub>
- 443 of them are sealed into the ledger, each carrying a receipt derived from the one before it.
  <sub>SEALED · `408867a7-ff6f-8031-9d29-e7b812ec0cb1`</sub>
...
- The ledger records 2307 entries with 0 chain breaks, 0 duplicate keys and 0 duplicate receipts.
  <sub>SEALED · `f3b2b723-d7cd-8e8b-ae44-df52ba8902c6`</sub>
- The count is 2307, which is 288 octaves and 3 over — the octave is a target the theorems earn, never a quota they are invented to fill.
  <sub>SEALED · `5fb28bab-d3a5-8848-af55-6a0f9d899078`</sub>
...
21 Lean files in 5 wings, 398 theorems. The prose in this section is read out of the
...
2 of 398 theorems carry no comment of their own and are shown here as the gap they are, not
...
*14 claims, all verified · 398 Lean theorems · 2307 ledger entries · trial root `1602427c-431e-8e02-bdf0-3088a0dcb76a` · integrity, not truth · 0/7*
