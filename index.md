...
- The formal layer holds 404 theorems across 21 files, and no file uses sorry or native_decide outside a comment.
  <sub>SEALED · `2d08b983-31c1-8f34-8b0f-773ceda109bc`</sub>
- 396 of those 404 theorems close by decide, which is to say the kernel evaluates the proposition over its whole finite domain rather than accepting a declaration; the remaining 8 close by rfl and are declarations.
  <sub>SEALED · `814f6a9b-c9fc-82c2-b3d4-7e0e299a384f`</sub>
- 449 of them are sealed into the ledger, each carrying a receipt derived from the one before it.
  <sub>SEALED · `7199061f-e661-8c40-9bbe-ba7b853d94fa`</sub>
...
- The ledger records 2313 entries with 0 chain breaks, 0 duplicate keys and 0 duplicate receipts.
  <sub>SEALED · `0284be5e-7686-8ea9-82fd-127c50aaa603`</sub>
- The count is 2313, which is 289 octaves and 1 over — the octave is a target the theorems earn, never a quota they are invented to fill.
  <sub>SEALED · `6fe7e595-d6b5-8846-92ff-3ba6eb58008a`</sub>
...
21 Lean files in 5 wings, 404 theorems. The prose in this section is read out of the
...
**Mechanically translated** — `mechanical.lean`, 68 theorem(s). Generated by src/prove/emit.ts from the ledger's own tests — do not hand-edit; re-run the prover.
...
2 of 404 theorems carry no comment of their own and are shown here as the gap they are, not
...
*14 claims, all verified · 404 Lean theorems · 2313 ledger entries · trial root `6f296a79-a431-86ff-a0bd-9d823423175a` · integrity, not truth · 0/7*
