...
- The formal layer holds 407 theorems across 21 files, and no file uses sorry or native_decide outside a comment.
  <sub>SEALED · `ecd6e9eb-9982-80d5-87a4-f8002d2b6874`</sub>
- 399 of those 407 theorems close by decide, which is to say the kernel evaluates the proposition over its whole finite domain rather than accepting a declaration; the remaining 8 close by rfl and are declarations.
  <sub>SEALED · `89037ca6-43b9-8fdc-a3be-8b49ed072d04`</sub>
- 452 of them are sealed into the ledger, each carrying a receipt derived from the one before it.
  <sub>SEALED · `718de35c-e946-83c0-ad55-900e5bf0b0cf`</sub>
...
- The ledger records 2316 entries with 0 chain breaks, 0 duplicate keys and 0 duplicate receipts.
  <sub>SEALED · `9041c5ba-d11a-85f9-bd51-4c6920bba37b`</sub>
- The count is 2316, which is 289 octaves and 4 over — the octave is a target the theorems earn, never a quota they are invented to fill.
  <sub>SEALED · `a31c4176-14e8-8fe1-8745-d85373c34def`</sub>
...
21 Lean files in 5 wings, 407 theorems. The prose in this section is read out of the
...
**Mechanically translated** — `mechanical.lean`, 71 theorem(s). Generated by src/prove/emit.ts from the ledger's own tests — do not hand-edit; re-run the prover.
...
2 of 407 theorems carry no comment of their own and are shown here as the gap they are, not
...
*14 claims, all verified · 407 Lean theorems · 2316 ledger entries · trial root `c8b4a5cb-4489-8e2b-b5f6-b1334e2450b6` · integrity, not truth · 0/7*
