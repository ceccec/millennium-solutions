...
(\texttt{npm run latex-gate}). There are 609 of them across 32 files and
7 wings; 600 close by exhaustion over a stated finite domain and the
...
\paragraph{\texttt{classical.lean}}
...
\begin{theorem}[\texttt{classical\_settles\_its\_range}]
