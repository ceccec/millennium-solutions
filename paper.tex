...
\begin{theorem}[\texttt{the\_equation\_balances\_by\_atom\_count}]
\[ 2 \cdot \mathrm{atomsH2}_{1} + \mathrm{atomsO2}_{1} = 2 \cdot \mathrm{atomsH2O}_{1} \land 2 \cdot \mathrm{atomsH2}_{2} + \mathrm{atomsO2}_{2} = 2 \cdot \mathrm{atomsH2O}_{2} \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$
