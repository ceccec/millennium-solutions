...
(\texttt{npm run latex-gate}). There are 549 of them across 30 files and
6 wings; 541 close by exhaustion over a stated finite domain and the
...
\begin{theorem}[\texttt{this\_file\_settles\_none\_of\_the\_seven}]
