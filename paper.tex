...
(\texttt{npm run latex-gate}). There are 534 of them across 30 files and
6 wings; 526 close by exhaustion over a stated finite domain and the
...
\begin{theorem}[\texttt{reflection\_and\_gravity\_share\_one\_singularity}]
...
\begin{theorem}[\texttt{this\_file\_makes\_no\_physical\_claim}]
\[ \mathrm{physicalClaims} = 0 \land \left|\mathrm{digits}\right| = 10 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$
...
\begin{theorem}[\texttt{one\_second\_is\_c\_metres\_of\_light}]
\[ \mathrm{travel}\mathopen{}\left(1\right) = c \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$

\begin{theorem}[\texttt{the\_light\_second\_joins\_space\_and\_time}]
...
\begin{theorem}[\texttt{this\_file\_measures\_nothing}]
\[ \mathrm{physicalClaims} = 0 \land \left|\mathrm{defining}\right| = 7 \land \mathrm{travel}\mathopen{}\left(0\right) = 0 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$
...
\begin{theorem}[\texttt{this\_deposit\_explains\_predicts\_and\_constrains\_nothing}]
\[ \mathrm{explanations} = 0 \land \mathrm{predictions} = 0 \land \mathrm{theoriesConstrained} = 0 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$

\begin{theorem}[\texttt{arithmetic\_on\_a\_definition\_returns\_the\_definition}]
\[ 299792458 \bmod 9 = 1 \land \mathrm{explanations} = 0 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$
...
\[ \lnot \exists k \in [3,\,6,\,0] : \left|\operatorname{dedup}\left(\{\, k \cdot u \bmod 9 \mid u \in [1,\,2,\,4,\,5,\,7,\,8] \,\}\right)\right| = 6 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- exhausting 18 cases. \hfill$\square$
...
\begin{theorem}[\texttt{novelty\_is\_never\_established\_here}]
\[ \mathrm{noveltyEstablished} = 0 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$

\begin{theorem}[\texttt{neither\_claimed\_nor\_established}]
\[ \left|\{\, x \in \mathrm{sources} \mid \mathrm{novelty}\mathopen{}\left(x\right) \,\}\right| = 0 \land \mathrm{noveltyEstablished} = 0 \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- by evaluation; no domain is walked. \hfill$\square$
