...
(\texttt{npm run latex-gate}). There are 564 of them across 31 files and
7 wings; 556 close by exhaustion over a stated finite domain and the
...
\[ \mathrm{idOf}[\{\, x \in \mathrm{instruments} \mid \mathrm{claim}\mathopen{}\left(x\right) \,\}] = [1,\,2,\,3,\,8] \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- exhausting 4 cases. \hfill$\square$
...
\[ \mathrm{idOf}[\mathrm{instruments}] = [1,\,2,\,3,\,4,\,5,\,6,\,7,\,8] \]
\end{theorem}
\noindent\emph{Proof.} \texttt{by decide} --- exhausting 8 cases. \hfill$\square$
