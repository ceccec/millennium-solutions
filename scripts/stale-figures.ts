...
const PAST = /\b(measured|was|were|had|before|until|earlier|at the time|then|used to|once|previously|no longer|first draft|first version|marked|it said|said|returned|sat|stood|reported|this line|uuidna|mathlib|another repo)\b/i
