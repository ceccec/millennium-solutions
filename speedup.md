...
Grouping the 2380 receipts by the digital root of their address, the **sparsest** region is digit
**3** (232) — a candidate area to examine, not a finding. The ledger is currently held
at **2380** (the captain's cap): improving a theorem's name or proof heals the record without changing the
