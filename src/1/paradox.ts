...
// The gates make every module clear (gaps · seal · wholeness). The
...
export function report(): string {
  ...
  o += '  the gates make everything clear: ' + checkers.join(' · ') + ' check every module.\n'
  ...
  o += 'It locates exactly where trust must come from outside.'
  return o
}
