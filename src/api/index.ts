...
// THE CLAY FLOOR IS REMOVED (2026-09-14). clayFloor() joined the statements of index.lean into one string, checked
// it against 18 listed words, and fed "0 of 7" to the README, the paper, CHALLENGES and the gates. A word search
// proves nothing about a conjecture. The author: "this code proves nothing … remove the hacked code misleading the
// public". The author's claim is stated in his name on the front page.
