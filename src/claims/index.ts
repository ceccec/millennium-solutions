...
// ungameable backing; neither certifies the interpretation. (The 'floor' claim — "0/7 entailed … leaves all seven
// Millennium problems unsolved", recomputed from a constant — was removed 2026-09-14 at the author's instruction.)
...
export const CLAIMS: readonly Claim[] = [
  ...
  { id: 'bounds', text: 'the honesty toolkit publishes 9 content-addressed boundaries.',
    recompute: () => String(BOUNDARY_STATEMENTS.length), expect: '9' },
...
export function report(): string {
  ...
  o += '  the registry (bounded, gated) — integrity, not truth. it does not certify unregistered prose.'
  return o
}
