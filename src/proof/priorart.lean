...
def sources : List Source :=
  ...
  , (3,  0, false)   -- asymmetry.lean    — NONE OF IT IS THIS DEPOSIT'S. An involution is its own inverse by definition, a non-injective map loses information by definition, and "easy forwards, hard backwards" is the premise of public-key cryptography (Diffie–Hellman 1976). What is this deposit's is neither: it is that its own cross formulas are sorted into the two kinds and the difference is decided rather than assumed, on the ring it reasons about.
  , (4,  0, false)   -- authority.lean    — NO NOVELTY IS CLAIMED AND NONE IS DENIED. Membership, set difference and monotonicity over finite lists are elementary and older than anyone could name. This row is kind 1 rather than kind 2 because kind 2 asserts a search was performed and found nothing, and none was performed for these. What is this deposit's is not the arithmetic: it is that a rule about WHOSE STATEMENT MAY STAND is decided by the kernel instead of argued inside the gate that applies it.
  , (5,  0, false)   -- capacity.lean     — NEITHER IS THIS DEPOSIT'S. RFC 9562 reserves the six bits and the birthday bound is classical probability, older than computing. What is this deposit's is that the CONSEQUENCE of the reservation is decided here rather than left to prose — the capacity and the collision exponent that follow from a count this tree already seals in imprint.lean.
  , (6,  0, false)   -- closure.lean      — THE METHOD IS CANTOR'S AND THE FINITE CASE IS ELEMENTARY. What is this deposit's is the direction it is pointed: src/proof/diagonal.lean applies it to a diagram somebody else published, and this file applies the identical construction to THIS deposit's own vocabulary, over this deposit's own ring, using the nine properties its own files name. A limit exhibited rather than conceded.
  , (7,  0, false)   -- coils.lean        — NOT THIS DEPOSIT'S. "Two descriptions of the same set are equal" is the definition of a set. What is this deposit's is which descriptions in ITS vocabulary turn out to coincide, and that the clustering is derived rather than listed — this file is generated by scripts/coils.ts and hand-editing it would be overwritten.
  , (8,  0, false)   -- coin.lean         — the reflection d ↦ 10 − d is the TEN'S COMPLEMENT, and its sibling 9 − d the nines' complement — the method of complements, used to turn subtraction into addition in Pascal's calculator (1642), the Comptometer and the Curta, and in modern computer arithmetic. That it is an involution with a single fixed point is the property those machines rely on. Searched 2026-09-04, term "method of complements / nines' complement / ten's complement"; prior art found and credited
  , (9,  0, false)   -- demand.lean       — the named results the search data asks for — Bézout’s identity (Étienne Bézout, 1779; Bachet, 1624), the Chinese remainder theorem (Sunzi, c. 3rd–5th century), and others named in their theorems
  , (10, 0, false)   -- demand2.lean      — Wilson’s theorem — John Wilson; first proved by Joseph-Louis Lagrange, 1771; the Catalan conjecture on consecutive perfect powers — Eugène Catalan, 1844; proved by Preda Mihăilescu, 2002
  , (11, 0, false)   -- demand3.lean      — Legendre’s three-square theorem — Adrien-Marie Legendre, 1797; Carmichael numbers — Robert Carmichael, 1910; amicable pairs — known to antiquity
  , (12, 0, false)   -- diagonal.lean     — THE ARGUMENT IS CANTOR'S AND NOTHING HERE IMPROVES IT. It is one of the most cited arguments in mathematics and the finite case is the easy one. What is this deposit's is neither the argument nor its finite case: it is that a specific published ring of labels, drawn three times around three different subjects and captioned "THE ALGEBRA OF EVERYTHING", is put to it by the kernel and the subject it misses is exhibited rather than described.
  , (13, 0, false)   -- digits.lean       — COMPLEMENT ARITHMETIC IS NOT THIS DEPOSIT'S AND IS OLDER THAN THE DECIMAL POINT. That a number and its digitwise ten's-complement sum to a repunit-times-ten is a consequence of place value that any accountant's method already relies on. What is this deposit's is the accounting below: that the ring's four reflection pairs, written as two-digit numbers, are all congruent to one mod nine, and that zero's exception reappears one place up as an excursion rather than a failure.
  , (14, 0, false)   -- dimensions.lean   — NOTHING HERE IS NEW AND THE DERIVATION IS THE STANDARD ONE. Solving three linear equations for three exponents is what dimensional analysis IS, and the answers have been known since 1899. What this deposit adds is the quantifier: the textbook SOLVES for the exponents, and this EXHAUSTS every alternative in range and finds exactly one, so "these exponents" becomes "no others".
  , (15, 0, false)   -- discount.lean     — NOT THIS DEPOSIT'S, AND OLD. Subtracting what a control already produces is what a blank is for and has been since titration. What is this deposit's is that the rule is decided by the kernel and sits beside the measurement it governs, so the raw figure cannot be quoted without it.
  ...
  , (17, 0, false)   -- elementary.lean   — Euclid (Elements IX.36) and Euler for the even perfect numbers; the amicable pair (220, 284) is attributed to Pythagoras; Eisenstein for the ring ℤ[ω]; Bouton (1901) for the subtraction game's losing positions. None of these results is this deposit's. What is this deposit's is the DECISION of each over a stated finite range, axiom-free, and the honest record of where the range stops short of what the older claim asserted.
  , (18, 0, false)   -- energy.lean       — the laws of electrolysis — Michael Faraday, 1834; the enthalpy of combustion of hydrogen, standard physical chemistry
  , (19, 0, false)   -- equivalence.lean  — NONE OF IT IS THIS DEPOSIT'S AND ALL OF IT IS FOUNDATIONAL. That an equivalence relation partitions a set is the first theorem anyone proves about equivalence relations. What is this deposit's is that ITS OWN substitution licence — scripts/coils.ts, which tells a reader two formulas may stand for one another — is put to those three properties instead of being assumed to have them.
  , (20, 0, false)   -- families.lean     — quantifies the ℤ/9 arithmetic above; the underlying results are Fermat’s, Euler’s and Gauss’s
  , (21, 0, false)   -- flow.lean         — 2⁶ = 64 ≡ 1 (mod 9), so the powers of two modulo 9 repeat with period six — Euler's theorem for φ(9) = 6, and the order of 2 in U(9), both textbook. Credited, and bounded: what this file adds is the kernel proof that the flow used by `navier_stokes_flow_is_bounded` stays bounded at EVERY step, not only at the 48 that theorem checks.
  , (22, 0, false)   -- fnv.lean          — FNV-1a — Glenn Fowler, Landon Curt Noll and Phong Vo, 1991
  , (23, 0, false)   -- generated.lean    — the structure underneath is standard and is credited. The doubling orbit 1 → 2 → 4 → 8 → 7 → 5 → 1 modulo 9 is the cyclic group generated by 2 in U(9), of order 6 because that is the multiplicative order of 2 mod 9; the units are {1,2,4,5,7,8} and the non-units {0,3,6}. Textbook abstract algebra, and treated directly in the literature on doubling maps modulo odd integers. Bounded, so the credit stops where the earlier work does: what is NOT prior art is the generator that enumerates propositions over this ring and discards the ones true of every sibling; that machinery is this deposit's own. Verification by exhaustion in Lean is this deposit's contribution, and verification is not discovery.
  ...
  , (28, 0, false)   -- instruments.lean  — NO NOVELTY IS CLAIMED AND NONE IS DENIED. The three rules are elementary — a strict order with an unknown value, a partition of a list at its last marked position, and removal of every occurrence of a substring — and each is standard enough that naming one author would be arbitrary. This row is kind 1 rather than kind 2 because kind 2 asserts that a search was performed and found nothing, and no such search was performed for these. What is this deposit's is not the rules: it is that three of its own instruments hold them by decision of the kernel, instead of by a block of reasoning written inside the instrument that needs them and checked by that same instrument.
  , (29, 0, false)   -- involution.lean   — that a permutation of order two decomposes a finite set into fixed points and transpositions, and that the number of fixed points therefore matches the parity of the set, is classical and long predates this deposit. It is the orbit-counting argument in any first course. What is this deposit's own here is the EXHAUSTIVE decision over ℤ/9 and the measured refusal below.
  , (30, 1, false)   -- lanes.lean        — the safety bound below, decided
  , (31, 0, false)   -- ledgerclaims.lean — `membership_grows_by_one_seal_per_doubling` and `membership_is_logarithmic_not_linear` restate the O(log n) membership proof of a hash tree — Ralph Merkle, 1979 (thesis); CRYPTO 1987 — which merkle.lean in this same deposit already credits. Classified `unbounded` on the ground that the subject is this deposit's own ledger; the ledger is its own, the logarithm is not. Bounded: what is not prior art is what THIS ledger claims — the 967-receipt case, the saving arithmetic, and the 128-bit seal width as this deposit mints it.
  , (32, 0, false)   -- light.lean        — the exact numerical values below are DEFINITIONS adopted by the Conférence Générale des Poids et Mesures, not results of this deposit: the metre from the speed of light (17th CGPM, 1983) and the seven defining constants fixed exactly in the 2019 revision of the SI, effective 20 May 2019 (BIPM, https://www.bipm.org/en/measurement-units/si-defining-constants). Nothing here measures anything.
  , (33, 0, false)   -- mechanical.lean   — the Boolean rows are De Morgan's laws — Augustus De Morgan, 1847 — written in the arithmetic of {0,1}; the group rows are the additive group of Z/9. Both long prior. Searched 2026-09-04, terms "De Morgan's laws boolean algebra" and "additive group mod 9"; prior art found and credited
  , (34, 0, false)   -- merkaba.lean      — the partition into {3,6,9} and two three-element classes closed under doubling is the subgroup and coset structure of Z/9 under the action of U(9); Lagrange. One theorem already credits Euler for the polyhedron formula. Searched 2026-09-04; prior art found and credited
  , (35, 0, false)   -- merkle.lean       — the hash tree — Ralph Merkle, 1979 (thesis); CRYPTO 1987
  , (36, 0, false)   -- mirror.lean       — NONE OF IT IS THIS DEPOSIT'S. That an involution is fixed points plus 2-cycles is the first thing anyone proves about involutions, and the tens-complement is how children subtract. What is this deposit's is the accounting below — which residues pair, which is the centre, and which one the reflection carries out of the ring so that it must fold instead.
  , (37, 0, false)   -- nim.lean          — Nim — Charles L. Bouton, 1901; the Sprague–Grundy theorem — Roland Sprague, 1935 and Patrick M. Grundy, 1939
  , (38, 0, false)   -- nucleus.lean      — THE PHYSICS IS NOT THIS DEPOSIT'S AND NONE OF IT IS CLAIMED. The shell model and its closed-shell numbers 2, 8, 20, 28, 50, 82, 126 are Maria Goeppert Mayer and J. Hans D. Jensen, 1949, who shared the 1963 Nobel Prize for them; the level capacities below are 2j+1 in the standard filling order, which is textbook. The proton-to-electron mass ratio is measured, and CODATA publishes it. What is decided here is ARITHMETIC over lists of small naturals and nothing else: that certain prefix sums of a typed capacity list take certain values, that a product of numerators equals a product of denominators, and that one integer is not another. No theorem below decides anything about a nucleus.
  , (39, 0, false)   -- phenomena.lean    — the SI base quantities and their defining constants are definitions of the Conférence Générale des Poids et Mesures (2019 revision, effective 20 May 2019); the electrochemical results are Michael Faraday's laws of electrolysis, 1834, and the standard enthalpy of combustion of hydrogen. Every physical result named here has an earlier author or a standards body, and none is this deposit's.
