...
def sources : List Source :=
  ...
  , (9,  0, false)   -- flow.lean        — the order of 2 modulo 9 is six (Euler, φ(9) = 6): 2⁶ = 64 ≡ 1 (mod 9), textbook; credited
