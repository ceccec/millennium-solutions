...
// folding to one root. Each is a pointer to a rule already computed elsewhere; here they meet.
...
export function report(): string {
  ...
  o += '  the "the" concepts point to what is computed elsewhere; here they meet in one.'
  return o
}
